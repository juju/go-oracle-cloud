...
[**DiscoverInstance**](InstancesApi.md#DiscoverInstance) | **Get** /instance/{container} | Retrieve Names of all Instances in a Container
...
# **DiscoverInstance**
> InstanceDiscoverResponse DiscoverInstance($container)
...
> InstanceDiscoverResponse DiscoverRootInstance()
...
# **GetInstance**
> InstanceResponse GetInstance($name)
...
# **ListInstance**
> InstanceListResponse ListInstance($container, $tags)
