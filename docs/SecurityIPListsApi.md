...
------------- | ------------- | -------------
[**AddSecIPList**](SecurityIPListsApi.md#AddSecIPList) | **Post** /seciplist/ | Create a Security IP List
[**DeleteSecIPList**](SecurityIPListsApi.md#DeleteSecIPList) | **Delete** /seciplist/{name} | Delete a Security IP List
[**DiscoverRootSecIPList**](SecurityIPListsApi.md#DiscoverRootSecIPList) | **Get** /seciplist/ | Retrieve Names of Containers
[**DiscoverSecIPList**](SecurityIPListsApi.md#DiscoverSecIPList) | **Get** /seciplist/{container} | Retrieve Names of all Security IP Lists in a Container
[**GetSecIPList**](SecurityIPListsApi.md#GetSecIPList) | **Get** /seciplist/{name} | Retrieve Details of a Security IP List
[**ListSecIPList**](SecurityIPListsApi.md#ListSecIPList) | **Get** /seciplist/{container}/ | Retrieve Details of all Security IP Lists in a Container
[**UpdateSecIPList**](SecurityIPListsApi.md#UpdateSecIPList) | **Put** /seciplist/{name} | Update a Security IP List


# **AddSecIPList**
> SecIpListResponse AddSecIPList($body)
...
> SecIpListDiscoverResponse DiscoverRootSecIPList()
...
# **DiscoverSecIPList**
> SecIpListDiscoverResponse DiscoverSecIPList($container)

Retrieve Names of all Security IP Lists in a Container
...
# **GetSecIPList**
> SecIpListResponse GetSecIPList($name)
...
# **ListSecIPList**
> SecIpListListResponse ListSecIPList($container, $name)
...
# **UpdateSecIPList**
> SecIpListResponse UpdateSecIPList($name, $body)
